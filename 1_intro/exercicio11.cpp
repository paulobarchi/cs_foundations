...
int main()
{
  ...
  cout << "\nPrograma referente ao Exercicio 11 da Lista 1 - CAP241-4." << endl;
  cout << "Autor: Paulo Henrique Barchi." << endl;
  cout << "Verificação se dado polígono é ou não simples." << endl;
  ...
  simplePolygon polygon1(boundary1, numVertices);
  polygon1.printPolygon();
  if (polygon1.avaliaPolinomioSimples())
    cout << " é um polígono simples." << endl;
  else
    cout << " não é um polígono simples." << endl;

  // Caso de teste 2: polígono não-simples
  ...
  // Criação do polígono com estes elementos
  simplePolygon polygon2(boundary2, numVertices);
  polygon2.printPolygon();
  if (polygon2.avaliaPolinomioSimples()) 
    cout << " É um polígono simples." << endl;
  else
    cout << " Não é um polígono simples." << endl;
